...
let el = "3";
let f1 = 5;
document.querySelector('.out-4').textContent = el + f1;
...
document.querySelector('.out-6').textContent = el + f3;
...
function t8() {
    ...
    let data = document.querySelector('.i-8').value = 4; // получили значение
    // тут выводим
...
document.querySelector('.out-11').innerHTML = i11.value  + 55;
}
...
function t12() {
let i12_1 = document.querySelector('.i-12-1').value = "Ivan";
let i12_2 = document.querySelector('.i-12-2');
document.querySelector('.out-12').innerHTML = "Hello"+' '+i12_1+' '+i12_2.value;
}
...
let a = Number(i13_1.value);
let b = Number(i13_2.value);
...
document.querySelector('.out-16').innerHTML = i16_1.value+i16_2.value;
}
...
document.querySelector('.out-19').innerHTML = Number(i19_1.value) + Number(i19_2.value);
}
